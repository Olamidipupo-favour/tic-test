    ...
    <div className="flex flex-col text-white mt-10 overflow-x-auto">
          ...
          {data
            ...
            .map((item: any) => (
              ...
              >
                ...
                <td className="px-4 py-4 text-center">{item.service}</td>
                <td className="px-4 py-4 text-center">{item.meterNumber}</td>
                <td className="px-4 py-4  text-center">{item.pinToken}</td>
                <td
      ...
      <div className="flex mt-4">
        <button
          ...
          className="w-32 py-4 border border-[#111111]  rounded-l-lg disabled:opacity-80 disabled:cursor-not-allowed"
        >
          Previous
        </button>
        ...
        <button
          ...
          className="w-32 py-4 border border-[#111111] rounded-r-lg bg-primaryPurple disabled:opacity-80 disabled:cursor-not-allowed"
        >
          Next
        </button>
      </div>
